...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || '𝚁𝙰𝙷𝚄𝙻-𝙰𝙸;𝚁𝙰𝙷𝚄𝙻-𝙼𝙰𝚂𝚃𝙴𝚁;https://lokixer.onrender.com/file/sgdfhejsvvsuv.jpg',
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_xux8_zz94_4y94_z547_6326_4w80_0zwx_y9yw',
  ...
  CONTEXTINFO: process.env.CONTEXTINFO || `{"title": "𝚁𝙰𝙷𝚄𝙻-𝙰𝙸", "body": "ᴀᴡᴇꜱᴏᴍᴇ 🍉", "thumbnailUrl": "https://i.imgur.com/OWJc4Qx.jpeg", "renderLargerThumbnail": false, "mediaType": 1, "mediaUrl": "", "sourceUrl": "https://github.com/Loki-Xer/Jarvis", "showAdAttribution": true}`,
  ...
  ERROR_MSG: process.env.ERROR_MSG === undefined ? true : toBool(process.env.ERROR_MSG),
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ;𝚁𝙰𝙷𝚄𝙻-𝙼𝙰𝚂𝚃𝙴𝚁;https://lokixer.onrender.com/file/sgdfhejsvvsuv.jpg;',
  MENU_FONT: process.env.MENU_FONT || "0;0",
  SUDO: process.env.SUDO || '918149730236',
  ...
  LOG_MSG: process.env.LOG_MSG === undefined ? true : toBool(process.env.LOG_MSG),
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || '𝚁𝙰𝙷𝚄𝙻-𝙰𝙸;𝚁𝙰𝙷𝚄𝙻-𝙼𝙰𝚂𝚃𝙴𝚁;https://lokixer.onrender.com/file/sgdfhejsvvsuv.jpg',
